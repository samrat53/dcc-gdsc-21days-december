...
const UserDashBoard = () => {
  ...
  const handleSubmit = () => {
      ...
      if (!isValidUrl) {
        // Handle invalid URL, show an error message, or prevent submission
  ...
  return (
    <>
      <div className="custom-bg-color bounded flex flex-col items-center justify-center h-[100vh]">
        ...
        <div className="submission-form rounded-lg flex  items-center justify-center p-8 w-[60wh]">
          <select className="select select-bordered w-full max-w-xs">
            <option disabled selected>
              Select Domain
            </option>
            <option name="web" value="web">Web Development</option>
            <option name="android" value="android">Android Development</option>
            <option name="aiml" value="aiml">Artificial Intelligence & Machine Learning</option>
          </select>
          ...
          <div className="table-box overflow-x-auto w-[40%] ">
